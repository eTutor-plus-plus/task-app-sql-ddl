...
public class DDLAnalyzer {
    ...
    public HashMap<DDLEvaluationCriterion, DDLCriterionAnalysis> analyze(Serializable submission, DDLAnalyzerConfig config) throws SQLException {
        ...
        if (config.isCriterionToAnalyze(DDLEvaluationCriterion.CORRECT_TABLES)) {
            ...
            analysis.put(DDLEvaluationCriterion.CORRECT_TABLES, criterionAnalysis);
            if (criterionAnalysis.getAnalysisException() != null && !criterionAnalysis.isCriterionSatisfied()) {
                return analysis;
            }
        }
        ...
        if (config.isCriterionToAnalyze(DDLEvaluationCriterion.CORRECT_COLUMNS)) {
            ...
            analysis.put(DDLEvaluationCriterion.CORRECT_COLUMNS, criterionAnalysis);
            if (criterionAnalysis.getAnalysisException() != null && !criterionAnalysis.isCriterionSatisfied()) {
                return analysis;
            }
        }
        ...
        if (config.isCriterionToAnalyze(DDLEvaluationCriterion.CORRECT_PRIMARY_KEYS)) {
            ...
            analysis.put(DDLEvaluationCriterion.CORRECT_PRIMARY_KEYS, criterionAnalysis);
            if (criterionAnalysis.getAnalysisException() != null && !criterionAnalysis.isCriterionSatisfied()) {
                return analysis;
            }
        }
        ...
        if (config.isCriterionToAnalyze(DDLEvaluationCriterion.CORRECT_FOREIGN_KEYS)) {
            ...
            analysis.put(DDLEvaluationCriterion.CORRECT_FOREIGN_KEYS, criterionAnalysis);
            if (criterionAnalysis.getAnalysisException() != null && !criterionAnalysis.isCriterionSatisfied()) {
                return analysis;
            }
        }
        ...
        if (config.isCriterionToAnalyze(DDLEvaluationCriterion.CORRECT_CONSTRAINTS)) {
            ...
            analysis.put(DDLEvaluationCriterion.CORRECT_CONSTRAINTS, criterionAnalysis);
            if (criterionAnalysis.getAnalysisException() != null && !criterionAnalysis.isCriterionSatisfied()) {
                return analysis;
            }
        }
